    ...
    <div class="footer-right-column">
      <div class="footer-section-links-container">
        <div class="footer-column-content">
          <a href="http://indots.com/index.html" class="footer-link-anchor">
            <span class="footer-link indots-font-cabin-regular">INICIO</span>
          </a>
          <a href="http://indots.com/que-es-indots.html" class="footer-link-anchor">
            <span class="footer-link indots-font-cabin-regular">QUÉ ES INDOTS</span>
          </a>
          <a href="http://indots.com/nuestros-cursos.html" class="footer-link-anchor">
            <span class="footer-link indots-font-cabin-regular">NUESTROS CURSOS</span>
          </a>
          <a href="http://indots.com/flash-indots.html" class="footer-link-anchor">
