...
<aside id="secondary" class="widget-area" role="complementary">
    ...
    <form class="form footer_form" onsubmit="sendNewsletterEmail(); return false;" id='getEmailByPerson'>
        <div class="input_text">
            <input required type="form_sub" class="form-control1 indots-font-cabin-regular" id="correo"
                   placeholder="Correo electrónico">
        </div>
        <button class="indots-button green indots-font-cabin-regular" type="submit" name="submit">Suscribirme</button>
    </form>
